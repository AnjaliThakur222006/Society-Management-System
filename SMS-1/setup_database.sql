...
-- Create visitors table (for /admin/reports)
...
-- Create deliveries table (for /admin/reports)
CREATE TABLE IF NOT EXISTS deliveries (
    id INT PRIMARY KEY AUTO_INCREMENT,
    resident_id INT,
    delivery_company VARCHAR(255),
...
-- Create vehicles table (for /tenant/parking)
CREATE TABLE IF NOT EXISTS vehicles (
    id INT PRIMARY KEY AUTO_INCREMENT,
    resident_id INT NOT NULL,
...
-- Insert sample data for visitors (last 30 days)
INSERT IGNORE INTO visitors (visitor_name, visit_date, entry_time, purpose, flat_number) VALUES
('John Visitor', CURDATE(), '10:30:00', 'Family Visit', 'A-101'),
('Delivery Person', DATE_SUB(CURDATE(), INTERVAL 1 DAY), '14:15:00', 'Package', 'A-101'),
('Ravi Kumar', DATE_SUB(CURDATE(), INTERVAL 2 DAY), '18:45:00', 'Meeting', 'B-202');

-- Insert sample data for deliveries
INSERT IGNORE INTO deliveries (resident_id, delivery_company, delivery_item, status) VALUES
(1, 'Amazon', 'Electronics Package', 'Delivered'),
(2, 'Flipkart', 'Clothing Order', 'Collected');

-- Insert sample vehicles for tenants
INSERT IGNORE INTO vehicles (resident_id, vehicle_number, vehicle_type) VALUES
(2, 'MH12AB1234', 'Car'),
(1, 'MH12XY5678', 'Bike');
